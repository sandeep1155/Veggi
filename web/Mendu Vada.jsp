<%-- 
    Document   : Mendu Vada
    Created on : Sep 28, 2017, 1:31:06 PM
    Author     : sandeep
--%>
...
<div class="row">
<div class="col-sm-5" >
        <div class="panel-heading"><b>Mendu Vada</b></div>
        <div class="panel-body"><img src="images/mendu vada.jpg" class="img-responsive" style="width:100%" alt="Image"></div>
      </div>

<div class="col-sm-7">
        <h3><b>Mendu Vada</b></h3>
