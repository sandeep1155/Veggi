<%-- 
    Document   : CholeBhature
    Created on : Sep 24, 2017, 9:53:07 PM
    Author     : sandeep
--%>
...
<div class="row">
<div class="col-sm-5" >
        <div class="panel-heading"><b>Chole Bhature</b></div>
        <div class="panel-body"><img src="images/Chole bhature.jpg" class="img-responsive" style="width:100%" alt="Image"></div>
      </div>

<div class="col-sm-7">
        <h3><b>Chole Bhature</b></h3>
