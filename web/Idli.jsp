<%-- 
    Document   : Idli
    Created on : Sep 28, 2017, 1:18:45 PM
    Author     : sandeep
--%>
...
<div class="row">
<div class="col-sm-5" >
        <div class="panel-heading"><b>Idli Sambhar</b></div>
        <div class="panel-body"><img src="images/idli.jpg" class="img-responsive" style="width:100%" alt="Image"></div>
      </div>

<div class="col-sm-7">
        <h3><b>Idli Sambhar</b></h3>
