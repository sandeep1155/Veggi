<%-- 
    Document   : Idli Upmam
    Created on : Sep 28, 2017, 1:20:29 PM
    Author     : sandeep
--%>
...
<div class="row">
<div class="col-sm-5" >
        <div class="panel-heading"><b>Idli Upmam</b></div>
        <div class="panel-body"><img src="images/Idliupmam.jpg" class="img-responsive" style="width:100%" alt="Image"></div>
      </div>

<div class="col-sm-7">
        <h3><b>Idli Upmam</b></h3>
	...
	<hr>
		...
		<h4 style="color:#F08080"><img src="images/ic_pink.png" /><b>120</b> </h4>
                <div>   
<h5><b> </b>36km/kg CNG Manual & 25.4 Kmpl Petrol Manual</p></h5>
</div>
</div><hr>
	<br><br>		
