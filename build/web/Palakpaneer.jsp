<%-- 
    Document   : Palakpaneer
    Created on : Sep 24, 2017, 9:50:47 PM
    Author     : sandeep
--%>

<%-- 
    Document   : Palak Paneermain
    Created on : Sep 24, 2017, 9:42:34 PM
    Author     : sandeep
--%>
...
<div class="row">
<div class="col-sm-5" >
        <div class="panel-heading"><b>Palak Paneer</b></div>
        <div class="panel-body"><img src="images/Palakpaneer.jpg" class="img-responsive" style="width:100%" alt="Image"></div>
      </div>

<div class="col-sm-7">
        <h3><b>Palak Paneer</b></h3>
